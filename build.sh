...
echo "Building terrabrasilis/geoserver-analyzer:$VERSION"
echo "...................................................."
...
# --no-cache
docker build --build-arg ENV=$ENV --build-arg BUILD_TYPE=$BUILD_TYPE -t terrabrasilis/geoserver-analyzer:$VERSION -f Dockerfile .
